...
public class simplat_attribute_editor extends PApplet {
...
public void drawTexture(int x, int y, int _pixSize, int texPackNum) {
  fill(255);
...
public void importAttributes() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "simplat_attribute_editor" };
    if (passedArgs != null) {
